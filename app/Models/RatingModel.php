...
class RatingModel extends AdminModel
{
        ...
        protected $folderUpload        = 'rating' ;
        protected $fieldSearchAccepted = ['id', 'name', 'description', 'link'];
        protected $crudNotAccepted     = ['_token','thumb_current','_method','type'];
    ...
    public function listItems($params = null, $options = null) {
        ...
        if($options['task'] == "admin-list-items") {
            $query = $this->select('id', 'status','name','slug','content','created', 'created_by', 'modified', 'modified_by');
            ...
            $result =  $query->orderBy('id', 'desc')
                            ->paginate($params['pagination']['totalItemsPerRating']);
    ...
    public function getItem($params = null, $options = null) { 
        ...
        if($options['task'] == 'get-item') {
            $result = self::select('id','name','slug','content', 'status')->where('id', $params['id'])->first();
        }
