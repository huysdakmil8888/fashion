...
class ColorModel extends AdminModel
{
    ...
    {
        return $this->belongsToMany(ProductModel::class,'product_color','color_id','product_id')->withPivot('value');
    }
    ...
    public function listItems($params = null, $options = null)
    {
        ...
        if($options['task'] == 'news-list-items-get-product-color-in-cart') {
            ...
            // echo '<h3>Die is Called Color Model</h3>';die;
        }
    ...
    public function saveItem($params = null, $options = null)
    {
        ...
        if ($options['task'] == 'change-type-color') {
            $typeColor = $params['selectedTypeColor'];
            $this->where('id', $params['id'])->update(['type_color' => $typeColor]);
            return [
                'id' => $params['id'],
                'message' => config('zvn.notify.success.update')
            ];
    ...
    public function getItem($params = null, $options = null)
    {
        ...
        if ($options['task'] == 'admin-list-items-get-all-color-name') {
