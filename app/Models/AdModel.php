...
//            $query = $this->select('id', 'name', 'position', 'status', 'link', 'thumb','created', 'created_by', 'modified', 'modified_by');
              $query=$this;
        ...
        if($options['task'] == 'news-list-items') {
            $query = $this->select('id','position', 'description', 'link', 'thumb','ordering')
                        ->where('status', '=', 'active' )
...
;
    ...
    public function getItem($params = null, $options = null) { 
        ...
        if($options['task'] == 'get-item') {
            $result = self::select('id', 'position','ordering', 'description', 'status', 'link', 'thumb')->where('id', $params['id'])->first();
        }
        if($options['task'] == 'news-list-items') {
            $query = $this->select('id','position', 'description', 'link', 'thumb','ordering')
